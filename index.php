...
.intro_background{top:-1px;left:0;width:100%;height:20px;background-repeat:no-repeat;background-size:cover;background-position:center center}
...
<div class="conatiner-fluid p-4" style="background-color: none;margin-top:1px;">
   <!-- <h2 class="text-center mb-3 mt-3 display-4"
	   style="font-style: normal;font-size:80px;">Main Attractions In India</h2>   
	<div class="row p-5 pb-0"> -->

<!-- <div class="conatiner-fluid p-4" style="background-color: none;margin-top:0px;"> -->
 
	</div>
	<footer class="mt-5">
	<em><h6 style="background:#7D7B82;" class="text-dark text-center p-0 brand mt-2">
				<img src="assets/images/plane-logo.png" 
					height="45px" width="45px" alt="">	
					&copy; <?php echo date('Y')?> - Online Flight Booking<br><br>			
			</h6></em>
